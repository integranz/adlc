...
Five user-invoked skills (`disable-model-invocation: true`), each with arguments, defaults and a safety note. Invoke as `/adlc:<name>` once the plugin is installed. Status: 3 of 5 implemented.
